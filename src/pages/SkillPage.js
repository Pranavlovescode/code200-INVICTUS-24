...
//         <div className="lg:w-4/5 mx-auto flex flex-wrap">
//           <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
//             <h2 className="text-sm title-font text-gray-500 tracking-widest">{skill.title}</h2>
//             <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">{skill.title}</h1>
//             <div className="flex mb-4">
//               <a className="flex-grow text-indigo-500 border-b-2 border-indigo-500 py-2 text-lg px-1">Description</a>
...
//   //     {selected === "0" ? (
//   //       <>
//   //         <p className='text-xl font-semibold'>skill Decsription</p>

//   //         <span className='text-base'>{skill?.detail[0]?.desc}</span>

//   //         {skill?.detail[0]?.requirement && (
//   //           <>
...
//   //             {skill?.company?.name}
//   //           </p>
//   //           <span className='text-base'>{skill?.company?.location}</span>
//   //           <span className='text-sm'>{skill?.company?.email}</span>
//   //         </div>

//   //         <p className='text-xl font-semibold'>About Company</p>
//   //         <span>{skill?.company?.about}</span>
//   //       </>
//   //     )}
//   //   </div> */}
          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                ...
                <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">{skill.title}</h1>
                <div className="flex mb-4">
                  <Link to={`/skills/${id}/description`} className="flex-grow text-indigo-500 border-b-2 border-indigo-500 py-2 text-lg px-1">Description</Link>
                  {/* Add links to other sections as needed */}
                </div>
                <p className="leading-relaxed mb-4">{skill.description}</p>
                {/* Additional details based on your API response */}
                <Link to="/">Go back to skills</Link>
              </div>
              <img
                alt="ecommerce"
