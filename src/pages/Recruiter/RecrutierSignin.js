...
export default function RecrutierSignin({onCloseSignin,openSignin,openLogin,onCloseLogin}) { // Renamed the component to SignUp
  ...
  const handleSubmit = async (event) => { // Updated to async
